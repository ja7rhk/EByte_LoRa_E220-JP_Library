#include "Arduino.h"
	...
	#define OPERATING_FREQUENCY 850
//**koseki(2023.1.26)	
#elif defined(FREQUENCY_920)
	#define OPERATING_FREQUENCY 920
//**
#else
	#define OPERATING_FREQUENCY 410
#endif
//**Note
//BW = 125kHz
//	freq = 920.6MHz + CH * 200kHz
//BW = 250kHz
//	freq = 920.7MHz + CH * 200kHz
//BW = 500kHz
//	freq = 920.8MHz + CH * 200kHz
...
//  AIR_DATA_RATE_111_625 = 0b111
  AIR_DATA_RATE_015_625 = 0b00000,	// SF=5, BW=125
  AIR_DATA_RATE_009_375 = 0b00100,	// SF=6, BW=125
  AIR_DATA_RATE_005_469 = 0b01000,	// SF=7, BW=125
  AIR_DATA_RATE_003_125 = 0b01100,	// SF=8, BW=125
  AIR_DATA_RATE_001_758 = 0b10000,	// SF=9, BW=125
  AIR_DATA_RATE_031_250 = 0b00001,	// SF=5, BW=250
  AIR_DATA_RATE_018_750 = 0b00101,	// SF=6, BW=250
  AIR_DATA_RATE_010_938 = 0b01001,	// SF=7, BW=250
  AIR_DATA_RATE_006_250 = 0b01101,	// SF=8, BW=250
  AIR_DATA_RATE_003_516 = 0b10001,	// SF=9, BW=250
  AIR_DATA_RATE_001_953 = 0b10101,	// SF=10, BW=250
  AIR_DATA_RATE_062_500 = 0b00010,	// SF=5, BW=500 (default)
  AIR_DATA_RATE_037_500 = 0b00110,	// SF=6, BW=500
  AIR_DATA_RATE_021_875 = 0b01010,	// SF=7, BW=500
  AIR_DATA_RATE_012_500 = 0b01110,	// SF=8, BW=500
  AIR_DATA_RATE_007_031 = 0b10010,	// SF=9, BW=500
  AIR_DATA_RATE_003_906 = 0b10110,	// SF=10, BW=500
  AIR_DATA_RATE_002_148 = 0b11010	// SF=11, BW=500
//**
};
...
//**koseki(2023.1.26)
	...
	//	return F("62.5kbps");
	//	break;
	case AIR_DATA_RATE_015_625:
		return F("15.625kbps SF=5, BW=125");
		break;
	case  AIR_DATA_RATE_009_375:
		return F("9.375kbps SF=6, BW=125");
		break;
	case  AIR_DATA_RATE_005_469:
		return F("5.469kbps SF=7, BW=125");
		break;
	case  AIR_DATA_RATE_003_125:
		return F("3.125kbps SF=8, BW=125");
		break;
	case  AIR_DATA_RATE_001_758:
		return F("1.758kbps SF=9, BW=125");
		break;
	case  AIR_DATA_RATE_031_250:
		return F("31.25kbps SF=5, BW=250");
		break;
	case  AIR_DATA_RATE_018_750:
		return F("18.75kbps SF=6, BW=250");
		break;
	case  AIR_DATA_RATE_010_938:
		return F("10.938kbps SF=7, BW=250");
		break;
	case  AIR_DATA_RATE_006_250:
		return F("6.25kbps SF=8, BW=250");
		break;
	case  AIR_DATA_RATE_003_516:
		return F("3.516kbps SF=9, BW=250");
		break;
	case  AIR_DATA_RATE_001_953:
		return F("1.953kbps SF=10, BW=250");
		break;
	case  AIR_DATA_RATE_062_500:
		return F("62.5kbps SF=5, BW=500 (default)");
		break;
	case  AIR_DATA_RATE_037_500:
		return F("37.5kbps SF=6, BW=500");
		break;
	case  AIR_DATA_RATE_021_875:
		return F("21.875kbps SF=7, BW=500");
		break;
	case  AIR_DATA_RATE_012_500:
		return F("12.5kbps SF=8, BW=500");
		break;
	case  AIR_DATA_RATE_007_031:
		return F("7.031kbps SF=9, BW=500");
		break;
	case  AIR_DATA_RATE_003_906:
		return F("3.960kbps SF=10, BW=500");
		break;
	case  AIR_DATA_RATE_002_148:
		return F("2.148kbps SF=11, BW=500");
		break;
//**
	  default:
